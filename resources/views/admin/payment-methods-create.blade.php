...
@section('title', '新增付款方式 - 管理後台')
@section('page-title', '新增付款方式')
...
@section('content')
    ...
    <div class="form-container">
        <h2 style="color: #2c3e50; margin-bottom: 30px;">新增付款方式</h2>
        ...
        <form action="{{ route('admin.payment-methods.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-section">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" id="method_name" name="method_name" value="{{ old('method_name') }}" required maxlength="20">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-help">支援 JPG, PNG, GIF 格式</div>
                ...
                <div class="form-group full-width">
                    ...
                    <input type="text" id="api_endpoint" name="api_endpoint" value="{{ old('api_endpoint') }}" maxlength="255">
            ...
            <div class="form-section">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="merchant_id" name="merchant_id" value="{{ old('merchant_id') }}">
                </div>
            ...
            <div class="form-section">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="sandbox_merchant_id" name="sandbox_merchant_id" value="{{ old('sandbox_merchant_id') }}">
                </div>
                
                <div class="form-row">
                    <div class="form-group">
                        <label for="sandbox_api_key">測試 API 金鑰</label>
                        <input type="text" id="sandbox_api_key" name="sandbox_api_key" value="{{ old('sandbox_api_key') }}">
                    </div>
                    
                    <div class="form-group">
                        <label for="sandbox_api_secret">測試 API 密鑰</label>
                        <input type="password" id="sandbox_api_secret" name="sandbox_api_secret" value="{{ old('sandbox_api_secret') }}">
                    </div>
                </div>
            </div>
            ...
            <div class="form-section">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="number" id="fee_percentage" name="fee_percentage" value="{{ old('fee_percentage', 0) }}" min="0" max="100" step="0.01">
                        <div class="form-help">例如：2.5 代表 2.5%</div>
                    </div>
                    
                    <div class="form-group">
                        <label for="fee_fixed">固定手續費 (元)</label>
                        <input type="number" id="fee_fixed" name="fee_fixed" value="{{ old('fee_fixed', 0) }}" min="0" step="0.01">
            ...
            <div class="form-actions">
                <button type="submit" class="btn btn-primary">新增付款方式</button>
